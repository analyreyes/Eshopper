...
<head>
    ...
    <meta name="Molina Gustavo" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 261 8758</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> GustavoyJoahna@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
